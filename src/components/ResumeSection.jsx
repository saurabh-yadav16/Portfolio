...
export default function ResumeSection({ onDownloadResume }) {
  return (
    <section id="exact-resume" className="py-12 bg-[#090d16] text-slate-900 font-serif">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Controls Bar */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6 bg-slate-900/90 p-4 rounded-2xl border border-slate-800 font-sans text-white">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-xl bg-[#26D868]/15 border border-[#26D868]/30 text-[#26D868]">
              <FileText className="w-5 h-5" />
            </div>
            <div>
              <h3 className="font-bold text-sm text-white">Saurabh Yadav — Official Resume</h3>
              <p className="text-xs text-slate-400">Single-page document matching original PDF formatting</p>
            </div>
          </div>
        ...
        {/* Paper Document Body - 100% Matching Layout */}
        <div className="bg-white text-slate-950 p-8 sm:p-14 rounded-xl shadow-2xl border border-slate-200 font-serif leading-normal text-sm">
          
          {/* Header */}
          <div className="text-center pb-2">
            <h1 className="text-3xl sm:text-4xl font-serif text-slate-950 tracking-normal mb-1 font-normal">
              Saurabh Yadav
            </h1>
            <div className="text-xs sm:text-sm text-slate-800 font-serif flex flex-wrap items-center justify-center gap-2 mt-1">
              <a href="tel:+918052680534" className="hover:underline text-slate-900">+91-8052680534</a>
              <span>|</span>
              <a href="mailto:saurabhyadav082005@gmail.com" className="hover:underline text-slate-900">saurabhyadav082005@gmail.com</a>
              <span>|</span>
              <a href="https://www.linkedin.com/in/saurabh-yadav-599b6a42b/" target="_blank" rel="noopener noreferrer" className="hover:underline text-slate-900">LinkedIn</a>
              <span>|</span>
              <a href="https://github.com/saurabh-yadav16" target="_blank" rel="noopener noreferrer" className="hover:underline text-slate-900">GitHub</a>
              <span>|</span>
              <a href="#hero" className="hover:underline text-slate-900">Portfolio</a>
            </div>
          </div>
          ...
          <div className="mt-4">
            ...
            <p className="text-xs sm:text-sm text-slate-900 leading-relaxed text-justify font-serif">
          ...
          <div className="mt-4">
            ...
            <div className="mb-4 font-serif">
              <div className="flex justify-between items-baseline text-xs sm:text-sm">
                ...
                <div className="space-x-1 text-xs">
                  <a href="https://github.com/saurabh-yadav16" target="_blank" rel="noopener noreferrer" className="hover:underline text-slate-900">GitHub</a>
                  <span>|</span>
                  <a href="https://syncparty-demo.vercel.app" target="_blank" rel="noopener noreferrer" className="hover:underline text-slate-900">Live</a>
                </div>
              </div>
              <p className="text-xs text-slate-800 italic mt-0.5">
                React.js, Node.js, Express.js, MongoDB, Socket.IO, Tailwind CSS, JWT
              </p>
              <ul className="text-xs text-slate-900 space-y-1 mt-1 pl-2">
            ...
            <div className="mb-4 font-serif">
              <div className="flex justify-between items-baseline text-xs sm:text-sm">
                ...
                <div className="space-x-1 text-xs">
                  <a href="https://github.com/saurabh-yadav16/Food-Waste-Management-System" target="_blank" rel="noopener noreferrer" className="hover:underline text-slate-900">GitHub</a>
                  <span>|</span>
                  <a href="https://food-waste-management-system-seven.vercel.app/" target="_blank" rel="noopener noreferrer" className="hover:underline text-slate-900">Live</a>
                </div>
              </div>
              <p className="text-xs text-slate-800 italic mt-0.5">
            ...
            {/* Project 3: AI Interview Coach */}
            <div className="mb-4 font-serif">
              <div className="flex justify-between items-baseline text-xs sm:text-sm">
                <span className="font-bold text-slate-950 text-sm">AI Interview Coach</span>
                <div className="space-x-1 text-xs">
                  <a href="https://github.com/saurabh-yadav16/AI-Interview-Coach" target="_blank" rel="noopener noreferrer" className="hover:underline text-slate-900">GitHub</a>
                  <span>|</span>
                  <a href="https://ai-interview-coach-eta-sandy.vercel.app/" target="_blank" rel="noopener noreferrer" className="hover:underline text-slate-900">Live</a>
                </div>
              </div>
              <p className="text-xs text-slate-800 italic mt-0.5">
          ...
          <div className="mt-4">
            ...
            <ul className="text-xs sm:text-sm text-slate-900 space-y-1 font-serif pl-2">
